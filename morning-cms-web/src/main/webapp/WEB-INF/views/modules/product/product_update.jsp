        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${ctx}/product/list/${product.productId}/edit" data-method="post">
            <div class="form-group m-t">
              ...
              <div class="col-sm-7">
                <input type="text" class="form-control" name="productNumber" disabled value="${product.productNumber}">
              </div>
            </div>
            ...
            <div class="form-group m-t">
              ...
              <div class="col-sm-7">
                <input type="text" disabled class="form-control" name="name" disabled value="${product.name}">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
